...
**Project**: joyful-sparkle-festival 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: Build a confetti app using react-confetti@6.2.0 
...
```sh
git clone https://github.com/GPT-Engineer-App-Dev/joyful-sparkle-festival.git
cd joyful-sparkle-festival
npm i
